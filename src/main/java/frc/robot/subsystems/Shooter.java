...
public class Shooter extends SubsystemBase {
    ...
    static final TreeMap<Double, ShooterValues> shooterSpeeds = new TreeMap<>(Map.ofEntries(
            ...
            // close to Stage
            Map.entry(6.0, new ShooterValues(1500.0, 1500.0, Math.toRadians(50))),
            // more in center area
            Map.entry(FieldConstants.FIELD_LENGTH/2, new ShooterValues(1500.0, 1500.0, Math.toRadians(40)))
            ));
