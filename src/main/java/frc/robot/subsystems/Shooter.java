...
public class Shooter extends SubsystemBase {
    ...
    static final TreeMap<Double, ShooterValues> shooterSpeeds = new TreeMap<>(Map.ofEntries(
            ...
            Map.entry(Units.inchesToMeters(137.4), new ShooterValues(3100.0, 3100.0, Math.toRadians(30.5 + 0.5))),
            Map.entry(Units.inchesToMeters(146.5), new ShooterValues(3400.0, 3300.0, Math.toRadians(29.5 + 0.5))),
            Map.entry(Units.inchesToMeters(168.0), new ShooterValues(3850.0, 3700.0, Math.toRadians(26.0 + 1))),
    ...
    public void setShooterRpms(double leftRpm, double rightRpm) {
        ...
        SmartDashboard.putNumber("shooter/rightRpmTarget", rightRpm);
