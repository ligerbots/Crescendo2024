    ...
    protected static final Map<Translation2d, String[]> s_pathLookup = new HashMap<>() {
        {
            ...
            put(FieldConstants.NOTE_C_4, new String[] { "Start_3 to Note_C_4", "Shoot_2 to Note_C_4", "Note_C_4 to Shoot_2" });
            put(FieldConstants.NOTE_C_5, new String[] { "Start_3 to Note_C_5", "Note_S_3 to Note_C_5", "Note_C_5 to Shoot_2" });
