    ...
    protected static final Map<Translation2d, String[]> s_pathLookup = new HashMap<>() {
        {
            ...
            put(FieldConstants.NOTE_C_3, new String[] { "Start_1 to Note_C_3", "Start_2 to Note_C_3", "Shoot_1 to Note_C_3", "Shoot_2 to Note_C_3", "Note_S_1 to Note_C_3", "Note_C_3 to Shoot_1" });
            ...
            put(FieldConstants.BLUE_NOTE_S_1, new String[] { "Start_1 to Note_S_1", "Start_2 to Note_S_1", "Start_3 to Note_S_1", "Note_S_2 to Note_S_1", "Shoot_1 to Note_S_1", null });
